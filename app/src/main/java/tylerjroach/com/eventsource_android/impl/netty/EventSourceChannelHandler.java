...
public class EventSourceChannelHandler extends SimpleChannelUpstreamHandler implements ConnectionHandler {
    ...
    public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e) throws Exception {
        ...
        request.headers().set(Names.ACCEPT, "text/event-stream");
        ...
        request.headers().set(Names.HOST, uri.getHost());
        request.headers().set(Names.ORIGIN, uri.getScheme() + "://" + uri.getHost());
        request.headers().set(Names.CACHE_CONTROL, "no-cache");
        if (lastEventId != null) {
