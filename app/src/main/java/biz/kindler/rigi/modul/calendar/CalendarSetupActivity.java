...
public class CalendarSetupActivity extends Activity implements EasyPermissions.PermissionCallbacks {
    ...
    public static final int RESULT_SUCCESFULL_SETUP    = 100;
        ...
        switch(requestCode) {
            ...
            case REQUEST_ACCOUNT_PICKER:
                if (resultCode == RESULT_OK && data != null && data.getExtras() != null) {
                    ...
                    if (accountName != null) {
                        SharedPreferences settings = getSharedPreferences(MainActivity.PREFS_ID, Context.MODE_PRIVATE);
